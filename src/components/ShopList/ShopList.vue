<template>
  ...
  <div class="msite_shop_list">
    <div class="shop_container" v-if="shopList.length">
      <ul class="shop_list">
            ...
            <div class="shop_right">
              <section class="shop_detail_header">
                ...
                <ul class="shop_detail_ul" v-for="(support, index) in item.supports" :key="index">
                  <li class="supports" :style="{color: support.icon_color}">{{support.icon_name}}</li>
                </ul>
              </section>
              <section class="shop_rating_order">
                <section class="shop_rating_order_left">
                  <Star :source="item.rating" :size="24"></Star>
                ...
                <section class="shop_rating_order_right">
                  <span class="delivery_style delivery_right" :style="{color: item.delivery_mode.color}">{{item.delivery_mode.text}}</span>
                </section>
              </section>
...
<script>
  ...
  export default {
    ...
    mounted () {
      this.$store.dispatch('receive_shop')
    },
    computed: mapState({
